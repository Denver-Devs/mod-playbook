...
It removes users from the server, but they can join back via any valid invite. This action is easily circumvented since Denver Devs has a public Discord URL. 
